...
function moveObjects(state, action) {
  ...
  const boom = state.gameState.boom ? state.gameState.boom : false;
  ...
  const objectsDestroyed = checkCollisions([boom], flyingObjects);
  // const objectsDestroyed = checkCollisions(boom) || 
